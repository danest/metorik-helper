...
class Metorik_Helper_API_Products extends WC_REST_Posts_Controller
{
    ...
    {
        add_action('rest_api_init', [$this, 'products_ids_route']);
    ...
    {
        register_rest_route($this->namespace, '/products/ids/', [
            'methods'             => WP_REST_Server::READABLE,
            'callback'            => [$this, 'products_ids_callback'],
    ...
    {
        register_rest_route($this->namespace, '/products/updated/', [
            'methods'             => WP_REST_Server::READABLE,
            'callback'            => [$this, 'products_updated_callback'],
            'permission_callback' => [$this, 'get_items_permissions_check'],
        ]);
    }
